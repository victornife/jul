...
s = p.read_text()
old = r'''\tif !contains(res.HotReload, "admin.history_keep") || !contains(res.RestartRequired, "admin.history_dir") {
\t\tt.Fatalf("unexpected mixed history classification: hot=%v restart=%v", res.HotReload, res.RestartRequired)
\t}'''
new = r'''\tif !contains(res.RestartRequired, "admin.history_dir") {
