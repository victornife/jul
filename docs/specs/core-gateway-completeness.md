...
> **Proposed.** [ADR 0018](../adr/0018-bounded-route-matching-and-response-policy.md) accepts D12
> and, on merge, freezes the public names: `[servers.locations.match]` gains `methods` plus the
...
| Routing/response policy | #117 — [ADR 0018](../adr/0018-bounded-route-matching-and-response-policy.md) proposed | #145-#147 |
