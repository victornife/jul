...
> **Decided.** [ADR 0018](../adr/0018-bounded-route-matching-and-response-policy.md) accepts D12 and
> freezes the public names: `[servers.locations.match]` gains `methods` plus the
