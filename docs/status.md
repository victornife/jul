...
| gRPC ↔ JSON transcoding (Y2-01) | 2026-06-21 | ⏳ soak pending (requires gRPC traffic — not exercised by HTTP-only load harness) — [evidence](soak-evidence.md#2026-07-06--phase-2a-consolidated-burn-in-completed-local-windows-8-hours-50-workers) |
| Native gRPC passthrough (Y2-04) | 2026-06-21 | ⏳ soak pending (requires gRPC traffic — not exercised by HTTP-only load harness) — [evidence](soak-evidence.md#2026-07-06--phase-2a-consolidated-burn-in-completed-local-windows-8-hours-50-workers) |
...
| Service discovery / dynamic upstreams (Y2-05) | 2026-07-03 | ⏳ soak pending (will be exercised via -phase2a soak) — [evidence](soak-evidence.md#2026-07-06--phase-2a-consolidated-burn-in-completed-local-windows-8-hours-50-workers) |
| Secrets references + log redaction (SEC-1) | 2026-07-03 | ⏳ soak pending (will be exercised via -phase2a soak with env-expanded admin token) — [evidence](soak-evidence.md#2026-07-06--phase-2a-consolidated-burn-in-completed-local-windows-8-hours-50-workers) |
...
| WASM plugin system (Y2-02) | 2026-07-03 | ⏳ soak pending (will be exercised via -phase2a soak with WASM plugin paths) — [evidence](soak-evidence.md#2026-07-06--phase-2a-consolidated-burn-in-completed-local-windows-8-hours-50-workers) |
