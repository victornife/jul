...
| WASM plugin system (Y2-02) | 2026-07-03 | ✅ 5m isolated Linux smoke test completed 2026-07-12 (286 successes, 0 errors; `header-inject` plugin exercised) and 8h Linux soak completed 2026-07-12 (33,428 successful requests, 0 errors, plugin continued to execute normally) — [evidence](soak-evidence.md#2026-07-12--wasm-plugin-isolated-smoke-test-linux-completed) |
