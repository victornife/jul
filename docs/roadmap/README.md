...
> Version 2.4 · Updated 2026-08-08
>
...
| **4 — Structured configuration Phase 5** | Batch preview, entity CRUD, global operations, Console migration, E2E | Preview/apply share one executor and authoritative lifecycle data | ▶ in progress: #77/#78 complete; #79 implementation in review |
...
- roadmap Stage 4 = #62 structured configuration Phase 5, current with #79 in review.
...
#78 — typed Route creation/deletion (complete)
    ↓
#79 — typed App/upstream creation/deletion (implementation in review)
    ↓
#80 → #82 — remaining Phase 5 structured configuration (blocked until #79 merges)
    ↓
...
current serial Phase 5 item is #79, with its implementation in review; #80-#82
remain downstream until that evidence merges. Shared edits to the configuration
schema, lifecycle, composition root, reload transaction, or Console patch
contracts remain serial.
...
Closed-world generated lifecycle authority (#89) is complete. #79 is the current
serial structured-configuration item and is in review; #80 remains blocked until
#79 merges with evidence.
