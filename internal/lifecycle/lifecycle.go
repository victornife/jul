...
var Registry = []Entry{
	...
	{Path: "global.worker_threads", Class: RestartRequiredClass, Subsystem: "worker_threads", Reason: "GOMAXPROCS cap is applied once at startup", StartupConsumed: true},
	...
	{Path: "global.redact_min_secret_length", Class: RestartRequiredClass, Subsystem: "redact", Reason: "redaction floor is captured in the startup fingerprint", StartupConsumed: true},
	...
	{Path: "admin.console", Class: RestartRequiredClass, Subsystem: "admin", Reason: "admin console flag is read at startup"},
	{Path: "admin.history_dir", Class: RestartRequiredClass, Subsystem: "admin", Reason: "config history directory is opened at startup"},
	{Path: "admin.history_keep", Class: RestartRequiredClass, Subsystem: "admin", Reason: "config history retention is configured at startup"},
	{Path: "admin.rate_limit_read_per_min", Class: RestartRequiredClass, Subsystem: "admin", Reason: "admin rate-limit buckets are created at startup"},
	{Path: "admin.rate_limit_write_per_min", Class: RestartRequiredClass, Subsystem: "admin", Reason: "admin rate-limit buckets are created at startup"},
	{Path: "admin.rate_limit_apply_per_min", Class: RestartRequiredClass, Subsystem: "admin", Reason: "admin rate-limit buckets are created at startup"},
	{Path: "admin.max_event_conns", Class: RestartRequiredClass, Subsystem: "admin", Reason: "event-source connection limit is configured at startup"},
	{Path: "admin.audit_log_file", Class: RestartRequiredClass, Subsystem: "admin", Reason: "audit log sink is opened at startup"},
	{Path: "admin.audit_log_rotate_max_mb", Class: RestartRequiredClass, Subsystem: "admin", Reason: "audit log rotation is configured at startup"},
	{Path: "admin.audit_log_rotate_keep", Class: RestartRequiredClass, Subsystem: "admin", Reason: "audit log rotation is configured at startup"},
	{Path: "admin.plugin_upload_dir", Class: RestartRequiredClass, Subsystem: "admin", Reason: "plugin upload directory is opened at startup"},
	{Path: "admin.plugin_upload_max_size", Class: RestartRequiredClass, Subsystem: "admin", Reason: "plugin upload limits are configured at startup"},
	{Path: "admin.plugin_upload_enabled", Class: RestartRequiredClass, Subsystem: "admin", Reason: "plugin upload endpoint is configured at startup"},
	...
	{Path: "cache.default_ttl", Class: RestartRequiredClass, Subsystem: "cache", Reason: "cache default TTL is fixed at backend creation"},
	{Path: "cache.stale_while_revalidate", Class: RestartRequiredClass, Subsystem: "cache", Reason: "cache stale policy is fixed at backend creation"},
	{Path: "cache.stale_if_error", Class: RestartRequiredClass, Subsystem: "cache", Reason: "cache stale policy is fixed at backend creation"},
	...
	{Path: "observability.tracing.exporter", Class: RestartRequiredClass, Subsystem: "tracing", Reason: "tracer exporter is created at startup"},
	...
	{Path: "observability.tracing.service_name", Class: RestartRequiredClass, Subsystem: "tracing", Reason: "tracer resource attributes are configured at startup"},
	{Path: "observability.tracing.insecure", Class: RestartRequiredClass, Subsystem: "tracing", Reason: "tracer transport security is configured at startup"},
	...
	{Path: "observability.access_log.rotate_max_mb", Class: RestartRequiredClass, Subsystem: "access_log", Reason: "file sink rotation is configured at startup"},
	{Path: "observability.access_log.rotate_keep", Class: RestartRequiredClass, Subsystem: "access_log", Reason: "file sink rotation is configured at startup"},
