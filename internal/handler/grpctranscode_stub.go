...
func NewGRPCTranscode(_ context.Context, _ config.ServerConfig, _ config.LocationConfig, _ map[string]config.UpstreamConfig, _ *upstream.Registry, _ *slog.Logger, _ func(method, code string), _ func(method, direction string)) (http.Handler, error) {
